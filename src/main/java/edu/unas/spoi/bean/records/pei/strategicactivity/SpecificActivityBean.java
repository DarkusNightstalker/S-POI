...
/**
 * The type Specific activity bean.
 *
 * @author Jhoan Brayam
 */
@ManagedBean
@SessionScoped
@Data
public class SpecificActivityBean implements java.io.Serializable, ILoadable {
    ...
    public void init() {
        ...
        pagination = new Pagination() {
            ...
            protected List searchRecords(int page, int recordsPerPage) {
                return specificActivityService.getListLazyForMainView(
                        page,
                        recordsPerPage,
                        strategicPlan.getId(),
                        code,
...
//</editor-fold>
        //<editor-fold defaultstate="collapsed" desc="StrategicAxisSearcher">
...
//<editor-fold defaultstate="collapsed" desc="Import">
    public class Import implements java.io.Serializable {
        ...
        @Asynchronous
        public void begin() {
            List<SpecificActivity> list = new ArrayList();
            try {
                Object file = null;
                try {
                ...
                for (int i = 1; i <= totalRecords; i++) {
                    ...
                    String code = null;
                    try {
                        code = o[3].toString().trim();
                        boolean exist = getSpecificActivityService().validateCode(code, getStrategicPlan().getId(), null);
                        if (exist) {
                            content += rowAsError(o);
                            throw new ImportException("ERROR : Codigo Invalido", "El codigo ya existe");
                        }
                        for (SpecificActivity item : list) {
                    ...
                    if (o[4] == null || "".equalsIgnoreCase((String) o[4])) {
                        content += rowAsError(o);
                        throw new ImportException("ERROR : Nombre Invalido", "El nombre no puede ser nulo o vacio");
                    }
//                    String specificGoal = (String) o[2];
//                    try {
//                        SpecificGoal sg = (SpecificGoal) getSpecificGoalService().addRestrictions(Arrays.asList((Criterion) Restrictions.eq("code", specificGoal))).get(0);
//                        item.setSpecificGoal(sg);
//                    } catch (Exception e) {
//                        throw new ImportException("ERROR : Objetivo especifico Invalido", "El codigo no puede ser nulo o vacio");
//                    }
                    content += "<tr class='animated fadeInRight'><td><span class='fa fa-check text-success'></span></td><td>" + o[0] + "</td><td>" + o[1] + "</td><td>" + o[2] + "</td><td>" + o[3] + "</td><td>" + o[4] + "</td></tr>";
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    getSpecificActivityService().saveOrUpdate(list.get(i));
                }
        ...
        private String rowAsError(Object[] o) {
            return "<tr class='danger animated fadeInRight'><td><span class='fa fa-times text-danger'></span></td><td>" + o[0] + "</td><td>" + o[1] + "</td><td>" + o[2] + "</td><td>" + o[3] + "</td><td>" + o[4] + "</td></tr>";
    ...
    public class Export implements java.io.Serializable {
        ...
        private String execute(JRExporter exporter) {
            try {
                ...
                InputStream is = servletContext.getResourceAsStream("/1258488425132154132154214536/StrategicActivity.jasper");
                ...
                response.addHeader("Content-disposition", "attachment; filename=Actividades_Estratégicas." + contentType.name().toLowerCase());
...
//</editor-fold>
    //<editor-fold defaultstate="collapsed" desc="ImportABP">

    /**
     * The type Import abp.
     */
    public class ImportABP implements java.io.Serializable {
            ...
            try {
                ...
                for (int i = 1; i <= totalRecords; i++) {
                    ...
                    try {
                        ...
                        aliasList.add("specificGoal", "spg");
                        aliasList.add("spg.strategicGoal", "stg");
                        aliasList.add("stg.strategicAxis", "sa");
                        CriterionList criterionList = new CriterionList()
                                ._add(Restrictions.eq("code", code))
                                ._add(Restrictions.eq("sa.strategicPlan", getStrategicPlan()));
                        SpecificActivity specificActivity = (SpecificActivity) getSpecificActivityService().addRestrictionsVariant(criterionList, aliasList).get(0);

                        if (o[1] instanceof Number) {
                            o[1] = ((Number) o[1]).intValue();
                        }
                        String[] abps = o[1].toString().trim().split(",");
                        criterionList.clear();
                        ...
                        specificActivity.setActivityBudgetPrograms(listABP);
                        list.add(specificActivity);
                    } catch (Exception e) {
                        content += rowAsError(o);
                        throw new ImportException("ERROR : Codigo Invalido", "El codigo no puede ser nulo o vacio");
                    }

                    content += "<tr class='animated fadeInRight'><td><span class='fa fa-check text-success'></span></td><td>" + o[0] + "</td><td>" + o[1] + "</td></tr>";
                    percentLoad = (i * 50) / totalRecords;
                }
                state = ImportUtils.State.PROCESS;
                int tempPercent = percentLoad;
