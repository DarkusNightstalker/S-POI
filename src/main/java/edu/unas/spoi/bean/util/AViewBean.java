...
public abstract class
        AViewBean<T extends Object, ID extends Number, S extends IGenericService> implements java.io.Serializable, ILoadable {
    ...
    protected void update(boolean widthDisabled) {
        ...
        if (selected instanceof AuditoryEntity) {
            ...
            Object[] users = (Object[]) getMainService().getListByRestrictions(projectionList, criterionList, aliasList).get(0);
