...
@ManagedBean
@SessionScoped
public class UoMBean implements java.io.Serializable, ILoadable {
    ...
    public void search() {
        ...
        data = uomService.addRestrictionsVariant(Arrays.asList(projectionList, criterionList, orderList));
    }
            ...
            try {
                ...
                for (int i = 1; i <= totalRecords; i++) {
                    ...
                    try {
                        ...
                        boolean exist = getUomService().existCode(code, null);
                        if (exist) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    getUomService().saveOrUpdate(list.get(i));
                }
    ...
    public class Export implements java.io.Serializable {
        ...
        private String execute(JRExporter exporter) {
            try {
                ...
                InputStream is = servletContext.getResourceAsStream("/1258488425132154132154214536/UoM.jasper");
                ...
                response.addHeader("Content-disposition", "attachment; filename=Unidades_Presupuestales." + contentType.name().toLowerCase());
