...
/**
 * The type Funding source bean.
 *
 * @author CORE i7
 */
@ManagedBean
@SessionScoped
public class FundingSourceBean implements java.io.Serializable, ILoadable {
    ...
    public void init() {
        import_ = new Import();
        export = new Export();
        pagination = new Pagination(fundingSourceService);
    }
        ...
        public void begin() {
            ...
            try {
                ...
                for (int i = 1; i <= totalRecords; i++) {
                    ...
                    FundingSource item = new FundingSource();
                    item.setCode(code);
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    getFundingSourceService().saveOrUpdate(list.get(i));
                }
    ...
    public class Export implements java.io.Serializable {
        ...
        private String execute(JRExporter exporter) {
            try {
                ...
                InputStream is = servletContext.getResourceAsStream("/1258488425132154132154214536/FundingSource.jasper");
                ...
                response.addHeader("Content-disposition", "attachment; filename=Fuentes_de_financiamiento." + contentType.name().toLowerCase());
