var ABP = function () {
    ...
    return {
        ...
        paginateResult: function () {
            $('#result-table').dataTable({
                ...
                "oLanguage": {
                    ...
                    "sZeroRecords": "No se han encontrado actividades presupuestales"
                }
            });
        },
        ...
        delete: function (name) {
            $.SmartMessageBox({
                title: "Aviso!",
                content: "Esta seguro de eliminar la actividad presupuestal '" + name + "'",
                buttons: '[No][Si]'
        ...
        recovery: function (name) {
            $.SmartMessageBox({
                title: "Aviso!",
                content: "Esta seguro de restaurar la actividad presupuestal '" + name + "'",
                buttons: '[No][Si]'
            }, function (ButtonPressed) {
                if (ButtonPressed === "Si") {
                    recovery();
