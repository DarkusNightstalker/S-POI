...
$(function () {
    BP.searcherConfigure();
    $("#jarvis-data-list .jarviswidget-ctrls").append('<a href="javascript:void(0);" class="button-icon jarviswidget-fullscreen-btn" rel="tooltip" title="" data-placement="bottom" data-original-title="Exportar"><i class="fa fa-download "></i></a>')
});
