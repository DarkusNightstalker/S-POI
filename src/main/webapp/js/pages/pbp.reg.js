var PBP = function () {
    ...
    return {
        ...
        paginateResult: function () {
            $('#result-table').dataTable({
                ...
                "oLanguage": {
                    ...
                    "sZeroRecords": "No se han encontrado productos"
                }
            });
        },
        ...
        beginSearch: function () {
            ...
            $("#budget-program").attr("disabled", "disabled");
        },
        search: function () {
            $("#form-search\\:code").val($("#code").val());
            $("#form-search\\:name").val($("#name").val());
            $("#form-search\\:budget-program").val($("#budget-program").val());
            search();
        },
        endSearch: function () {
            ...
            $("#budget-program").removeAttr("disabled");
            $("#code").focus();
        ...
        recovery: function (name) {
            $.SmartMessageBox({
                title: "Aviso!",
                content: "Esta seguro de restaurar el producto/proyecto '" + name + "'",
                buttons: '[No][Si]'
        ...
        delete: function (name) {
            $.SmartMessageBox({
                title: "Aviso!",
                content: "Esta seguro de eliminar el producto/proyecto '" + name + "'",
                buttons: '[No][Si]'
            }, function (ButtonPressed) {
                if (ButtonPressed === "Si") {
                    del();
