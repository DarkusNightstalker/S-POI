...
!function () {
    ...
    "use strict";
    var b, c, d, e, f, g, h = [];
    if (a = a.toUpperCase(), !a.match("((^[A-Z]{1}[0-9]{7}[A-Z0-9]{1}$|^[T]{1}[A-Z0-9]{8}$)|^[0-9]{8}[A-Z]{1}$)"))
        return !1;
    for (d = 0; 9 > d; d++)
        h[d] = parseInt(a.charAt(d), 10);
    for (c = h[2] + h[4] + h[6], e = 1; 8 > e; e += 2)
        f = (2 * h[e]).toString(), g = f.charAt(1), c += parseInt(f.charAt(0), 10) + ("" === g ? 0 : parseInt(g, 10));
    ...
    var c, d, e, f, g, h, i, j, k, l = a.replace(/ /g, "").toUpperCase(),
            ...
            o = "",
            p = "";
    if (!/^([a-zA-Z0-9]{4} ){2,8}[a-zA-Z0-9]{1,4}|[a-zA-Z0-9]{12,34}$/.test(l))
        return !1;
...
jQuery.validator.addMethod("unique", function(value, element, params) {
    ...
    $(selector,element.form).each(function() {
        if (value == $(this).val()) {
            matches.push($(this));
        }
    });
